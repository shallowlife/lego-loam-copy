# lego-loam-copy
可运行版本的lego-loam，原作者frame_id混乱，导致不能运行，这里仅在原来基础上统一了frame_id。
The runnable version of lego loam has a confusing frame_id by the original author, which prevents it from running. Here, only the frame_id has been unified based on the original version.
